...
module DupliTop (
  ...
  logic [DATA_SIZE-1:0] Centro_dout;
  logic Centro_empty_n;
  logic Centro_read;
  ...
  Avg_dup u_avg_dup (
      ...
      .Centro_dout       (Centro_dout),         //X
      .Centro_empty_n    (Centro_empty_n),      //X
      .Centro_read       (Centro_read),         //X    
  ...
  assign Centro_empty_n = valid_r_c;
  assign ready_r_c = Centro_read;
  assign Centro_dout = datoin_c;
  assign stage3 = 1'b0;
